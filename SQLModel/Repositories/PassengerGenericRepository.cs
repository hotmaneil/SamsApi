...
{
	public class PassengerGenericRepository<TEntity> : IGenericRepository<TEntity>
		where TEntity : class
	{
		...
		public PassengerGenericRepository()
			: this(new BarrierFreePassengerEntities())
		{
		}

		public PassengerGenericRepository(DbContext context)
		{
			if (context == null)
			{
		...
		public PassengerGenericRepository(ObjectContext context)
		{
			if (context == null)
			{
				throw new ArgumentNullException("context");
